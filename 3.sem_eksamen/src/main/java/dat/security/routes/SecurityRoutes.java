...
import static dat.security.controllers.SecurityController.getInstance;
...
public class SecurityRoutes {
    ...
    private static dat.security.controllers.SecurityController securityController = getInstance();
